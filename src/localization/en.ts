const en = {
  ...
  proxy: {
    ...
    mapping: {
      ...
      presets_target: 'Target for the pack',
      presets_target_placeholder: 'Pick a target model',
      presets_pack_openai: 'OpenAI',
      presets_pack_anthropic: 'Anthropic',
      presets_pack_gemini: 'Gemini',
      presets_preview_title: 'Apply the {{pack}} pack',
      presets_preview_description:
        'New aliases point at {{target}}. Aliases that already exist are kept unchanged.',
      presets_preview_additions: 'Will be added',
      presets_preview_conflicts: 'Already exists, left unchanged',
      presets_preview_nothing: 'Every alias in this pack already exists. Nothing will be added.',
      ...
      alias: 'Alias requested by clients',
      target: 'Canonical provider model',
      enabled: 'Enabled',
      disabled: 'Disabled',
      remove: 'Remove alias',
      status_known: 'Target is present in the current provider catalog',
      status_unknown_model: 'Target is not present in the current provider catalog',
      status_catalog_unavailable: 'Provider catalog is unavailable',
      status_unchecked: 'Availability has not been checked',
      available_accounts: '{{count}} account(s) available',
      wildcard: 'Wildcard alias',
      checked_at: 'Availability checked at {{time}}',
