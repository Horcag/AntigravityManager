...
const fr = {
  ...
  proxy: {
    ...
    mapping: {
      ...
      presets_target: 'Cible du pack',
      presets_target_placeholder: 'Choisissez un modèle cible',
      presets_pack_openai: 'OpenAI',
      presets_pack_anthropic: 'Anthropic',
      presets_pack_gemini: 'Gemini',
      presets_preview_title: 'Appliquer le pack {{pack}}',
      presets_preview_description:
        'Les nouveaux alias pointeront vers {{target}}. Les alias existants restent inchangés.',
      presets_preview_additions: 'Seront ajoutés',
      presets_preview_conflicts: 'Existent déjà, inchangés',
      ...
      alias: 'Alias demandé par le client',
      target: 'Modèle canonique du fournisseur',
      enabled: 'Activé',
      disabled: 'Désactivé',
      remove: "Supprimer l'alias",
      status_known: 'La cible est présente dans le catalogue actuel',
      status_unknown_model: "La cible n'est pas présente dans le catalogue actuel",
      status_catalog_unavailable: 'Le catalogue du fournisseur est indisponible',
      status_unchecked: "La disponibilité n'a pas été vérifiée",
      available_accounts: '{{count}} compte(s) disponible(s)',
      wildcard: 'Alias générique',
      checked_at: 'Disponibilité vérifiée à {{time}}',
