const tr = {
  ...
  proxy: {
    ...
    mapping: {
      ...
      presets_target: 'Paket hedefi',
      presets_target_placeholder: 'Hedef model seçin',
      presets_pack_openai: 'OpenAI',
      presets_pack_anthropic: 'Anthropic',
      presets_pack_gemini: 'Gemini',
      presets_preview_title: '{{pack}} paketini uygula',
      presets_preview_description:
        'Yeni aliaslar {{target}} hedefine işaret edecek. Zaten var olan aliaslar değiştirilmez.',
      presets_preview_additions: 'Eklenecek',
      presets_preview_conflicts: 'Zaten var, değiştirilmedi',
      ...
      alias: 'İstemci takma adı',
      target: 'Kanonik sağlayıcı modeli',
      enabled: 'Etkin',
      disabled: 'Devre dışı',
      remove: 'Takma adı kaldır',
      status_known: 'Hedef güncel sağlayıcı kataloğunda',
      status_unknown_model: 'Hedef güncel sağlayıcı kataloğunda değil',
      status_catalog_unavailable: 'Sağlayıcı kataloğu kullanılamıyor',
      status_unchecked: 'Kullanılabilirlik denetlenmedi',
      available_accounts: '{{count}} hesap kullanılabilir',
      wildcard: 'Joker takma ad',
      checked_at: 'Kullanılabilirlik {{time}} saatinde denetlendi',
