const ru = {
  ...
  proxy: {
    ...
    mapping: {
      title: 'Маппинг моделей',
      description:
        'Необязательные явные алиасы. По умолчанию список пуст, а запрос идёт на указанный канонический ID.',
      recent_misses_title: 'Незначимые запрошенные модели',
      recent_misses_empty: 'Недавно не найденных моделей нет.',
      recent_misses_count: '{{count}} запрос',
      recent_misses_last_seen: 'Последний раз {{time}}',
      create_miss_alias: 'Создать алиас из пропуска',
      clear_misses: 'Очистить пропуски',
      target_placeholder: 'Выберите каноническую модель',
      issue_empty_alias: 'Алиас пуст. Строка не сохраняется, пока вы не укажете имя.',
      issue_empty_target:
        'Цель не выбрана. Строка не сохраняется, пока вы не выберете каноническую модель.',
      issue_duplicate_alias:
        'Этот алиас уже занят другой строкой. Алиасы сравниваются без учёта регистра.',
      issue_shadows_canonical_model:
        'Этот алиас совпадает с реальным ID модели из текущего каталога и перекроет её.',
      presets_title: 'Наборы алиасов',
      presets_description:
        'Создайте алиасы, которые клиенты обычно прописывают в коде, — все указывают на одну выбранную вами цель. Каждый алиас становится обычной строкой, которую можно изменить или удалить.',
      presets_target: 'Цель для набора',
      presets_target_placeholder: 'Выберите целевую модель',
      presets_pack_openai: 'OpenAI',
      presets_pack_anthropic: 'Anthropic',
      presets_pack_gemini: 'Gemini',
      presets_preview_title: 'Применить набор {{pack}}',
      presets_preview_description:
        'Новые алиасы будут указывать на {{target}}. Уже существующие алиасы останутся без изменений.',
      presets_preview_additions: 'Будет добавлено',
      presets_preview_conflicts: 'Уже существует, остаётся без изменений',
      presets_preview_nothing: 'Все алиасы этого набора уже существуют. Ничего не будет добавлено.',
      ...
      alias: 'Алиас в запросе клиента',
      target: 'Каноническая модель провайдера',
      enabled: 'Включён',
      disabled: 'Выключен',
      remove: 'Удалить алиас',
      status_known: 'Цель есть в текущем каталоге провайдера',
      status_unknown_model: 'Цели нет в текущем каталоге провайдера',
      status_catalog_unavailable: 'Каталог провайдера недоступен',
      status_unchecked: 'Доступность ещё не проверена',
      available_accounts: 'Доступных аккаунтов: {{count}}',
      wildcard: 'Шаблонный алиас',
      checked_at: 'Доступность проверена в {{time}}',
      not_checked: 'Доступность не проверена',
      check: 'Проверить доступность',
      add: 'Добавить алиас',
      miss_cleared: 'Журнал пропусков очищен',
      miss_clear_failed: 'Не удалось очистить журнал пропусков',
      clear: 'Очистить алиасы',
    },
    'open-code': {
