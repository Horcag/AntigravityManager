const vi = {
  ...
  proxy: {
    ...
    mapping: {
      ...
      alias: 'Bí danh phía máy khách',
      target: 'Mô hình chuẩn của nhà cung cấp',
      enabled: 'Đã bật',
      disabled: 'Đã tắt',
      remove: 'Xóa bí danh',
      status_known: 'Đích có trong danh mục nhà cung cấp hiện tại',
      status_unknown_model: 'Đích không có trong danh mục nhà cung cấp hiện tại',
      status_catalog_unavailable: 'Danh mục nhà cung cấp không khả dụng',
      status_unchecked: 'Chưa kiểm tra tính khả dụng',
      available_accounts: '{{count}} tài khoản khả dụng',
      wildcard: 'Bí danh ký tự đại diện',
      checked_at: 'Đã kiểm tra lúc {{time}}',
