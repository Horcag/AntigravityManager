...
export const MODEL_ROUTE_MISS_JOURNAL_FILENAME = 'model-route-miss-journal.json';
...
export function defaultModelRouteMissJournalOptions(): ModelRouteMissJournalOptions {
  return {
    ...
    maxEntries: readPositiveIntegerEnv(
      'AGM_MODEL_ROUTE_MISS_JOURNAL_MAX_ENTRIES',
      MODEL_ROUTE_MISS_JOURNAL_MAX_ENTRIES,
    ),
    ttlMs: readPositiveIntegerEnv(
      'AGM_MODEL_ROUTE_MISS_JOURNAL_TTL_MS',
...
/**
 * Records which model ids clients asked for and this proxy could not serve.
 *
 ...
 * and a timestamp are kept — never a prompt or a request body.
 */
@Injectable()
