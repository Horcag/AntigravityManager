...
import type { OpenAIFileObject } from '../files/openai-file-resource';
...
export function openAIUploadErrorResponse(error: unknown): {
  statusCode: number;
  body: { error: { code: string; message: string; param: string | null; type: string } };
} {
...
export type OpenAIUploadCompletion = OpenAIFileObject;
